...
HD_PWD='C:/Users/Vladu/Desktop/AC/Vladut_Rad MIPS pipeline/MIPSpipeline/MIPSpipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPS.vds -m64 -mode batch -messageDb vivado.pb -notrace -source MIPS.tcl
