...
HD_PWD='C:/Users/Vladu/Desktop/AC/Vladut_Rad MIPS pipeline/MIPSpipeline/MIPSpipeline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPS.vdi -applog -m64 -messageDb vivado.pb -mode batch -source MIPS.tcl -notrace
